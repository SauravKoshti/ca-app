<?php $__env->startSection('title', 'Taxation'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="service-box p-4 shadow-lg rounded">
                                    ...
                                    <p class="text-muted">
                                    We furnish quality income tax counselling and compliancy with effective tax strategies, form an basic part of our advisory. We provide income tax advice to companies as well as non-companies clients. We design, structure and execute the tax planning most effectively according to the client suitability. We provide…
                                    </p>
                                    <ul class="service-list">
...
<?php echo $__env->make('users.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ca-app/resources/views/users/taxation.blade.php ENDPATH**/ ?>