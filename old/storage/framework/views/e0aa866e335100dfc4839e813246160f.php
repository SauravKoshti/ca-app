<?php $__env->startSection('title', 'MatualFund'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="service-box p-4 shadow-lg rounded">
                                    ...
                                    <p class="text-muted mutualfund-content">
                                    We perform for indian sponsors in setting up private equity funds, venture capital funds, mutual funds. A mutual fund is an investment option where money from many people is brought together to buy a variety of stocks, bonds, or other securities. we give them the help they require to be effective today and create long term gain for tomorrow. We provide all types of mutual fund like…
                                    </p>
...
<?php echo $__env->make('users.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ca-app/resources/views/users/mutualfund.blade.php ENDPATH**/ ?>