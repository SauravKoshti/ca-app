...
<section class="banner-sec">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active"><img src="{{ asset('assets/user/images/banner2.jpg') }}" alt="banner2"></div>
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <div class="services-box-item">
                    ...
                    <div class="icons"><img src="{{ asset('assets/user/images/mutual_fund.png') }}" alt=""
                                            title="">
                    </div>
                    <h4>Mutual Fund</h4>
                    ...
                    <div class="more"><a href={{ route('services.mutualfunds') }}>Read More <i
            ...
            <div class="col-md-4 col-xs-12">
                <div class="services-box-item">
                    ...
                    <div class="icons"><img src="{{ asset('assets/user/images/taxation.png') }}" alt=""
                                            title=""></div>
                    <h4>Taxation</h4>
                    <p>Taxes are of 4 types: Direct tax, Indirect tax, Business tax, and Property and Sales Tax.</p>
                    <div class="more"><a href={{ route('services.taxation') }}>Read More <i
                                class="fa fa-long-arrow-right"></i></a></div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="services-box-item">
                    ...
                    <div class="icons"><img src="{{ asset('assets/user/images/gst.png') }}" alt=""
                                            title=""></div>
                    <h4>GST</h4>
                    <p>Goods and Services Rates</p>
                    <div class="more"><a href={{ route('services.gst') }}>Read More <i
                                class="fa fa-long-arrow-right"></i></a></div>
                </div>
            </div>
            <div class="col-md-4 col-md-offset-2">
                <div class="services-box-item">
                    ...
                    <div class="icons"><img src="{{ asset('assets/user/images/accounting.png') }}" alt=""
                                            title=""></div>
                    <h4>Accounting</h4>
                    <p>Bank Statutory Audits, Concurrent Audits and Stock Audits.</p>
                    <div class="more"><a href={{ route('services.accounting') }}>Read More <i
                                class="fa fa-long-arrow-right"></i></a></div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="services-box-item">
                    ...
                    <div class="icons"><img src="{{ asset('assets/user/images/pancard.png') }}" alt=""
                                            title=""></div>
                    <h4>Pancard</h4>
                    <p>Permanent Account Number</p>
                    <div class="more"><a href="{{ route('services.pancard') }}">Read More <i
                                    class="fa fa-long-arrow-right"></i></a></div>
                </div>
            </div>
        </div>
...
<section class="our-unique-service">
<!--    <div class="row about-grid">-->
        <div class="col-md-4 col-xs-12 about-box">
