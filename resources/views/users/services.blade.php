                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-box p-4 shadow-lg rounded">
                            ...
                            <p class="text-muted">
                                We perform for Indian sponsors in setting up private equity funds, venture capital funds,
                                and mutual funds...
                            </p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-box p-4 shadow-lg rounded">
                            ...
                            <p class="text-muted">
                                GST has been made known, and since then, our company has been functioning as the prime GST
                                consultants...
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-box p-4 shadow-lg rounded">
                            ...
                            <p class="text-muted">
                                We help you to make your PAN card because PAN card is required wherever ID and signature
                                proof is required...
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="service-box p-4 shadow-lg rounded">
                            ...
                            <ul class="service-list">
                                <li><i class="fas fa-lightbulb text-warning"></i> Providing information to clients on law
                                    updates</li>
                                <li><i class="fas fa-lightbulb text-warning"></i> Liaison with clients and departments on a
                                    regular basis</li>
                                <li><i class="fas fa-lightbulb text-warning"></i> Compilation of details needed for filing
                                    returns</li>
                                <li><i class="fas fa-lightbulb text-warning"></i> Preparation of challans needed for making
                                    tax payments</li>
