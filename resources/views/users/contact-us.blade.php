                    ...
                    <div class="card contact-card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="fa fa-map-pin text-danger"></i> <strong>Address:</strong> Station Rd, opp. Bhagvatsinhji High School, Venkateshwara Nagar, Dhoraji, Gujarat 360410</li>
                                <li><i class="fa fa-phone text-success"></i> <strong>Phone:</strong> +99740 25198</li>
                                <li><i class="fa fa-envelope text-warning"></i> <strong>Email:</strong> vishaljagani403@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('contacts.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mobile" name="mobile" class="form-control" placeholder="Your number">
                                </div>
                                <div class="form-group">
