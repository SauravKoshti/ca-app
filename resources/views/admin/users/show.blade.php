                            ...
                            <div class="document-card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-primary" onclick="downloadSelected('pdf')">Download
                                            Pdf</button>
                                        <button class="btn btn-primary" onclick="downloadSelected('zip')">Download
                                            Zip</button>
                                    </div>
                                </div>
                                <div class="card-body">
