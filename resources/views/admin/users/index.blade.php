...
<script>
    ...
    const isSelectAll = document.getElementById('select-all').checked;

    document.getElementById('is_select_all').value = isSelectAll ? 1 : 0;
    ...
    if (!isSelectAll) {
        ...
        selectedIds.forEach(id => {
            ...
            clone.value = id;
            document.getElementById('pdfExportForm').appendChild(clone);
        });
    }
